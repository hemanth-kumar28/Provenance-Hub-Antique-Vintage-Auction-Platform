<?php
$pageTitle = 'Provenance Hub | My Bids';
...
<div class="flex min-h-[calc(100vh-72px)]">
    ...
    <main class="flex-1 p-6 md:p-12 max-w-7xl mx-auto w-full">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-1 gap-10">
            <!-- Full Column: Active Bids -->
            <div class="space-y-10">
                <header class="flex justify-between items-center">
                    <h2 class="font-display text-2xl font-bold border-l-4 border-primary pl-4 uppercase tracking-tighter">All Engagements</h2>
                </header>
